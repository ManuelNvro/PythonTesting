...
extern "C" {
#endif
  #define OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_INDEX_JAC_NLSJac20 0
  int OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_functionJacNLSJac20_column(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *thisJacobian, ANALYTIC_JACOBIAN *parentJacobian);
  int OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_initialAnalyticJacobianNLSJac20(void* data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian);
#if defined(__cplusplus)
}
#endif
#if defined(__cplusplus)
