...
OMC_DISABLE_OPT
int OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_initialAnalyticJacobianNLSJac8(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian)
{
  TRACE_PUSH
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_231(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = DIVISION((data->localData[0]->realVars[128] /* pwLine1.vs.re variable */) * (jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */) + (data->localData[0]->realVars[127] /* pwLine1.vs.im variable */) * (jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */),sqrt((tmp0 * tmp0) + (tmp1 * tmp1)),"sqrt(pwLine1.vs.re ^ 2.0 + pwLine1.vs.im ^ 2.0)");
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_233(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp45)
  {
    ...
    else
    {
      ...
      tmp27 = (tmp21) * ((data->simulationInfo->realParameter[63]) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */));
    }
    ...
    else
    {
      ...
      tmp37 = (tmp31) * ((-1.0 + data->simulationInfo->realParameter[63]) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */));
    }
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_234(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[3] /* constantLoad.Q.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = ((tmp47 && tmp48)?(data->simulationInfo->realParameter[39]) * ((data->localData[0]->realVars[51] /* constantLoad.kI variable */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) + (jacobian->tmpVars[2] /* constantLoad.kI.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->localData[0]->realVars[55] /* constantLoad.v variable */)) + (data->simulationInfo->realParameter[43]) * (((2.0) * (data->localData[0]->realVars[55] /* constantLoad.v variable */)) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */)) + (jacobian->tmpVars[1] /* constantLoad.kP.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[41] + data->simulationInfo->realParameter[65]):(data->simulationInfo->realParameter[39]) * ((data->localData[0]->realVars[51] /* constantLoad.kI variable */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) + (jacobian->tmpVars[2] /* constantLoad.kI.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->localData[0]->realVars[55] /* constantLoad.v variable */)) + (data->simulationInfo->realParameter[43]) * (((2.0) * (data->localData[0]->realVars[55] /* constantLoad.v variable */)) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */)) + (jacobian->tmpVars[1] /* constantLoad.kP.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[41]));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_235(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[4] /* constantLoad.P.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = ((tmp49 && tmp50)?(data->simulationInfo->realParameter[40]) * ((data->localData[0]->realVars[51] /* constantLoad.kI variable */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) + (jacobian->tmpVars[2] /* constantLoad.kI.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->localData[0]->realVars[55] /* constantLoad.v variable */)) + (data->simulationInfo->realParameter[44]) * (((2.0) * (data->localData[0]->realVars[55] /* constantLoad.v variable */)) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */)) + (jacobian->tmpVars[1] /* constantLoad.kP.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[42] + data->simulationInfo->realParameter[64]):(data->simulationInfo->realParameter[40]) * ((data->localData[0]->realVars[51] /* constantLoad.kI variable */) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) + (jacobian->tmpVars[2] /* constantLoad.kI.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->localData[0]->realVars[55] /* constantLoad.v variable */)) + (data->simulationInfo->realParameter[44]) * (((2.0) * (data->localData[0]->realVars[55] /* constantLoad.v variable */)) * (jacobian->tmpVars[0] /* constantLoad.v.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */)) + (jacobian->tmpVars[1] /* constantLoad.kP.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[42]));
  TRACE_POP
}
...
equation index: 236
type: SIMPLE_ASSIGN
gENROE._PSId._$pDERNLSJac8._dummyVarNLSJac8 = (-gENROE.Xppd) * gENROE.id.SeedNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_236(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[5] /* gENROE.PSId.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = ((-data->simulationInfo->realParameter[239])) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac8 SEED_VAR */);
  TRACE_POP
}
...
equation index: 237
type: SIMPLE_ASSIGN
pwLine._is._re._$pDERNLSJac8._dummyVarNLSJac8 = ($cse7 * gENROE.iq.SeedNLSJac8 + $cse6 * gENROE.id.SeedNLSJac8) * gENROE.CoB
*/
...
equation index: 238
type: SIMPLE_ASSIGN
pwLine._is._im._$pDERNLSJac8._dummyVarNLSJac8 = ($cse6 * gENROE.iq.SeedNLSJac8 - $cse7 * gENROE.id.SeedNLSJac8) * gENROE.CoB
*/
...
equation index: 239
type: SIMPLE_ASSIGN
gENROE._uq._$pDERNLSJac8._dummyVarNLSJac8 = gENROE.PSId.$pDERNLSJac8.dummyVarNLSJac8 - gENROE.R_a * gENROE.iq.SeedNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_239(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[8] /* gENROE.uq.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = jacobian->tmpVars[5] /* gENROE.PSId.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[222]) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac8 SEED_VAR */));
  TRACE_POP
}
...
equation index: 240
type: SIMPLE_ASSIGN
gENROE._PSIq._$pDERNLSJac8._dummyVarNLSJac8 = (-gENROE.Xppq) * gENROE.iq.SeedNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_240(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[9] /* gENROE.PSIq.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = ((-data->simulationInfo->realParameter[240])) * (jacobian->seedVars[16] /* gENROE.iq.SeedNLSJac8 SEED_VAR */);
  TRACE_POP
}
...
equation index: 241
type: SIMPLE_ASSIGN
gENROE._ud._$pDERNLSJac8._dummyVarNLSJac8 = (-gENROE.PSIq.$pDERNLSJac8.dummyVarNLSJac8) - gENROE.R_a * gENROE.id.SeedNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_241(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[10] /* gENROE.ud.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = (-jacobian->tmpVars[9] /* gENROE.PSIq.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) - ((data->simulationInfo->realParameter[222]) * (jacobian->seedVars[17] /* gENROE.id.SeedNLSJac8 SEED_VAR */));
  TRACE_POP
}
...
equation index: 242
type: SIMPLE_ASSIGN
pwLine._vs._re._$pDERNLSJac8._dummyVarNLSJac8 = $cse6 * gENROE.ud.$pDERNLSJac8.dummyVarNLSJac8 + $cse7 * gENROE.uq.$pDERNLSJac8.dummyVarNLSJac8
*/
...
equation index: 243
type: SIMPLE_ASSIGN
pwLine._vs._im._$pDERNLSJac8._dummyVarNLSJac8 = $cse6 * gENROE.uq.$pDERNLSJac8.dummyVarNLSJac8 - $cse7 * gENROE.ud.$pDERNLSJac8.dummyVarNLSJac8
*/
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_244(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[13] /* gENCLS.p.ir.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = (((-data->localData[0]->realVars[26] /* $cse1 variable */)) * (jacobian->seedVars[12] /* gENCLS.id.SeedNLSJac8 SEED_VAR */) - ((data->localData[0]->realVars[27] /* $cse2 variable */) * (jacobian->seedVars[13] /* gENCLS.iq.SeedNLSJac8 SEED_VAR */))) * (data->simulationInfo->realParameter[162]);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_245(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[14] /* gENCLS.p.ii.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = ((data->localData[0]->realVars[27] /* $cse2 variable */) * (jacobian->seedVars[12] /* gENCLS.id.SeedNLSJac8 SEED_VAR */) - ((data->localData[0]->realVars[26] /* $cse1 variable */) * (jacobian->seedVars[13] /* gENCLS.iq.SeedNLSJac8 SEED_VAR */))) * (data->simulationInfo->realParameter[162]);
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_246(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = ((-data->simulationInfo->realParameter[168])) * (jacobian->seedVars[13] /* gENCLS.iq.SeedNLSJac8 SEED_VAR */) - ((data->simulationInfo->realParameter[171]) * (jacobian->seedVars[12] /* gENCLS.id.SeedNLSJac8 SEED_VAR */));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_247(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = (data->simulationInfo->realParameter[171]) * (jacobian->seedVars[13] /* gENCLS.iq.SeedNLSJac8 SEED_VAR */) - ((data->simulationInfo->realParameter[168]) * (jacobian->seedVars[12] /* gENCLS.id.SeedNLSJac8 SEED_VAR */));
  TRACE_POP
}
...
equation index: 248
type: SIMPLE_ASSIGN
pwLine1._ir._re._$pDERNLSJac8._dummyVarNLSJac8 = (-pwLine4.ir.re.SeedNLSJac8) - gENCLS.p.ir.$pDERNLSJac8.dummyVarNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_248(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[17] /* pwLine1.ir.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[11] /* pwLine4.ir.re.SeedNLSJac8 SEED_VAR */) - jacobian->tmpVars[13] /* gENCLS.p.ir.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 249
type: SIMPLE_ASSIGN
pwLine1._ir._im._$pDERNLSJac8._dummyVarNLSJac8 = (-pwLine4.ir.im.SeedNLSJac8) - gENCLS.p.ii.$pDERNLSJac8.dummyVarNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_249(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[18] /* pwLine1.ir.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[10] /* pwLine4.ir.im.SeedNLSJac8 SEED_VAR */) - jacobian->tmpVars[14] /* gENCLS.p.ii.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 251
type: SIMPLE_ASSIGN
constantLoad._p._ii._$pDERNLSJac8._dummyVarNLSJac8 = (-pwLine.ir.im.SeedNLSJac8) - pwLine1.is.im.SeedNLSJac8 - pwLine3.is.im.SeedNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_251(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[20] /* constantLoad.p.ii.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[7] /* pwLine.ir.im.SeedNLSJac8 SEED_VAR */) - jacobian->seedVars[4] /* pwLine1.is.im.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[5] /* pwLine3.is.im.SeedNLSJac8 SEED_VAR */;
  TRACE_POP
}
...
equation index: 252
type: SIMPLE_ASSIGN
pwLine1._is._re._$pDERNLSJac8._dummyVarNLSJac8 = (-pwLine.ir.re.SeedNLSJac8) - pwLine3.is.re.SeedNLSJac8 - constantLoad.p.ir.SeedNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_252(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[21] /* pwLine1.is.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[6] /* pwLine.ir.re.SeedNLSJac8 SEED_VAR */) - jacobian->seedVars[3] /* pwLine3.is.re.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[2] /* constantLoad.p.ir.SeedNLSJac8 SEED_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_253(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->tmpVars[22] /* pwFault.p.ii.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ = (-jacobian->seedVars[0] /* pwLine3.ir.im.SeedNLSJac8 SEED_VAR */) - jacobian->seedVars[1] /* pwLine4.is.im.SeedNLSJac8 SEED_VAR */;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_254(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[0] /* $res1.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp51 && tmp52)?jacobian->seedVars[9] /* pwLine3.ir.re.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[304]) * (jacobian->seedVars[9] /* pwLine3.ir.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[301]) - ((jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[302]))) - ((data->simulationInfo->realParameter[303]) * (jacobian->seedVars[0] /* pwLine3.ir.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[301]) - ((jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[302]))))));
  TRACE_POP
}
...
equation index: 255
type: SIMPLE_ASSIGN
$res2._$pDERNLSJac8._dummyVarNLSJac8 = if time < pwFault.t1 then pwFault.p.ir.$pDERNLSJac8.dummyVarNLSJac8 else if time < pwFault.t2 and pwFault.ground then pwLine3.vr.im.SeedNLSJac8 else if time < pwFault.t2 then pwFault.p.ir.$pDERNLSJac8.dummyVarNLSJac8 - (pwFault.R * pwLine3.vr.re.SeedNLSJac8 + pwFault.X * pwLine3.vr.im.SeedNLSJac8) * (pwFault.R ^ 2.0 + pwFault.X ^ 2.0) / (pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0 else pwFault.p.ir.$pDERNLSJac8.dummyVarNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_255(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  else
  {
    ...
    if(tmp63)
    {
      tmp64 = jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp61)
      {
        ...
        tmp62 = jacobian->tmpVars[19] /* pwFault.p.ir.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[270]) * (jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */) + (data->simulationInfo->realParameter[271]) * (jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */)) * ((tmp56 * tmp56) + (tmp57 * tmp57)),(tmp60 * tmp60),"(pwFault.R ^ 2.0 + pwFault.X ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp62 = jacobian->tmpVars[19] /* pwFault.p.ir.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */;
      }
      tmp64 = tmp62;
    }
    tmp66 = tmp64;
  }
  jacobian->resultVars[1] /* $res2.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = tmp66;
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_256(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  if(tmp79)
  {
    tmp80 = jacobian->tmpVars[22] /* pwFault.p.ii.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */;
  }
  else
  {
    ...
    if(tmp77)
    {
      tmp78 = jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */;
    }
    else
    {
      ...
      if(tmp75)
      {
        ...
        tmp76 = jacobian->tmpVars[22] /* pwFault.p.ii.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ - (DIVISION(((data->simulationInfo->realParameter[270]) * (jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */) - ((data->simulationInfo->realParameter[271]) * (jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */))) * ((tmp70 * tmp70) + (tmp71 * tmp71)),(tmp74 * tmp74),"(pwFault.X ^ 2.0 + pwFault.R ^ 2.0) ^ 2.0"));
      }
      else
      {
        tmp76 = jacobian->tmpVars[22] /* pwFault.p.ii.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */;
      }
      tmp78 = tmp76;
    }
    tmp80 = tmp78;
  }
  jacobian->resultVars[2] /* $res3.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = tmp80;
  TRACE_POP
}
...
equation index: 257
type: SIMPLE_ASSIGN
$res4._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.is.re.$pDERNLSJac8.dummyVarNLSJac8 else pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 - pwLine1.vs.re.SeedNLSJac8 - (pwLine.Z.re * (pwLine.is.re.$pDERNLSJac8.dummyVarNLSJac8 + pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 * pwLine.Y.im - pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 * pwLine.Y.re) - pwLine.Z.im * (pwLine.is.im.$pDERNLSJac8.dummyVarNLSJac8 + (-pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8) * pwLine.Y.im - pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_257(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[3] /* $res4.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp81 && tmp82)?jacobian->tmpVars[6] /* pwLine.is.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ - jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[282]) * (jacobian->tmpVars[6] /* pwLine.is.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + (jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[279]) - ((jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[280]))) - ((data->simulationInfo->realParameter[281]) * (jacobian->tmpVars[7] /* pwLine.is.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + ((-jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */)) * (data->simulationInfo->realParameter[279]) - ((jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[280]))))));
  TRACE_POP
}
...
equation index: 258
type: SIMPLE_ASSIGN
$res5._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.is.im.$pDERNLSJac8.dummyVarNLSJac8 else pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 - pwLine1.vs.im.SeedNLSJac8 - (pwLine.Z.re * (pwLine.is.im.$pDERNLSJac8.dummyVarNLSJac8 + (-pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8) * pwLine.Y.im - pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 * pwLine.Y.re) + pwLine.Z.im * (pwLine.is.re.$pDERNLSJac8.dummyVarNLSJac8 + pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 * pwLine.Y.im - pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_258(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[4] /* $res5.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp83 && tmp84)?jacobian->tmpVars[7] /* pwLine.is.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */:jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ - jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[282]) * (jacobian->tmpVars[7] /* pwLine.is.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + ((-jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */)) * (data->simulationInfo->realParameter[279]) - ((jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[280]))) + (data->simulationInfo->realParameter[281]) * (jacobian->tmpVars[6] /* pwLine.is.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + (jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[279]) - ((jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) * (data->simulationInfo->realParameter[280])))));
  TRACE_POP
}
...
equation index: 259
type: SIMPLE_ASSIGN
$res6._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.ir.im.SeedNLSJac8 else pwLine1.vs.im.SeedNLSJac8 - pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 - (pwLine.Z.re * (pwLine.ir.im.SeedNLSJac8 + (-pwLine1.vs.re.SeedNLSJac8) * pwLine.Y.im - pwLine1.vs.im.SeedNLSJac8 * pwLine.Y.re) + pwLine.Z.im * (pwLine.ir.re.SeedNLSJac8 + pwLine1.vs.im.SeedNLSJac8 * pwLine.Y.im - pwLine1.vs.re.SeedNLSJac8 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_259(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[5] /* $res6.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp85 && tmp86)?jacobian->seedVars[7] /* pwLine.ir.im.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */ - jacobian->tmpVars[12] /* pwLine.vs.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[282]) * (jacobian->seedVars[7] /* pwLine.ir.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[279]) - ((jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[280]))) + (data->simulationInfo->realParameter[281]) * (jacobian->seedVars[6] /* pwLine.ir.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[279]) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[280])))));
  TRACE_POP
}
...
equation index: 260
type: SIMPLE_ASSIGN
$res7._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine.t1 and time < pwLine.t2 then pwLine.ir.re.SeedNLSJac8 else pwLine1.vs.re.SeedNLSJac8 - pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 - (pwLine.Z.re * (pwLine.ir.re.SeedNLSJac8 + pwLine1.vs.im.SeedNLSJac8 * pwLine.Y.im - pwLine1.vs.re.SeedNLSJac8 * pwLine.Y.re) - pwLine.Z.im * (pwLine.ir.im.SeedNLSJac8 + (-pwLine1.vs.re.SeedNLSJac8) * pwLine.Y.im - pwLine1.vs.im.SeedNLSJac8 * pwLine.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_260(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[6] /* $res7.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp87 && tmp88)?jacobian->seedVars[6] /* pwLine.ir.re.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */ - jacobian->tmpVars[11] /* pwLine.vs.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ - ((data->simulationInfo->realParameter[282]) * (jacobian->seedVars[6] /* pwLine.ir.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[279]) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[280]))) - ((data->simulationInfo->realParameter[281]) * (jacobian->seedVars[7] /* pwLine.ir.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[279]) - ((jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[280]))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_261(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[7] /* $res8.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp89 && tmp90)?jacobian->seedVars[3] /* pwLine3.is.re.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[304]) * (jacobian->seedVars[3] /* pwLine3.is.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[301]) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[302]))) - ((data->simulationInfo->realParameter[303]) * (jacobian->seedVars[5] /* pwLine3.is.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[301]) - ((jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[302]))))));
  TRACE_POP
}
...
equation index: 262
type: SIMPLE_ASSIGN
$res9._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine3.t1 and time < pwLine3.t2 then pwLine3.is.im.SeedNLSJac8 else pwLine1.vs.im.SeedNLSJac8 - pwLine3.vr.im.SeedNLSJac8 - (pwLine3.Z.re * (pwLine3.is.im.SeedNLSJac8 + (-pwLine1.vs.re.SeedNLSJac8) * pwLine3.Y.im - pwLine1.vs.im.SeedNLSJac8 * pwLine3.Y.re) + pwLine3.Z.im * (pwLine3.is.re.SeedNLSJac8 + pwLine1.vs.im.SeedNLSJac8 * pwLine3.Y.im - pwLine1.vs.re.SeedNLSJac8 * pwLine3.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_262(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[8] /* $res9.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp91 && tmp92)?jacobian->seedVars[5] /* pwLine3.is.im.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[304]) * (jacobian->seedVars[5] /* pwLine3.is.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[301]) - ((jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[302]))) + (data->simulationInfo->realParameter[303]) * (jacobian->seedVars[3] /* pwLine3.is.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[301]) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[302])))));
  TRACE_POP
}
...
equation index: 263
type: SIMPLE_ASSIGN
$res10._$pDERNLSJac8._dummyVarNLSJac8 = pwLine1.vs.im * constantLoad.p.ir.SeedNLSJac8 + pwLine1.vs.im.SeedNLSJac8 * constantLoad.p.ir + (-pwLine1.vs.re.SeedNLSJac8) * constantLoad.p.ii - constantLoad.Q.$pDERNLSJac8.dummyVarNLSJac8 - pwLine1.vs.re * constantLoad.p.ii.$pDERNLSJac8.dummyVarNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_263(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[9] /* $res10.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = (data->localData[0]->realVars[127] /* pwLine1.vs.im variable */) * (jacobian->seedVars[2] /* constantLoad.p.ir.SeedNLSJac8 SEED_VAR */) + (jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->localData[0]->realVars[54] /* constantLoad.p.ir variable */) + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */)) * (data->localData[0]->realVars[53] /* constantLoad.p.ii variable */) - jacobian->tmpVars[3] /* constantLoad.Q.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ - ((data->localData[0]->realVars[128] /* pwLine1.vs.re variable */) * (jacobian->tmpVars[20] /* constantLoad.p.ii.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */));
  TRACE_POP
}
...
equation index: 264
type: SIMPLE_ASSIGN
$res11._$pDERNLSJac8._dummyVarNLSJac8 = pwLine1.vs.im * constantLoad.p.ii.$pDERNLSJac8.dummyVarNLSJac8 + pwLine1.vs.im.SeedNLSJac8 * constantLoad.p.ii + pwLine1.vs.re * constantLoad.p.ir.SeedNLSJac8 + pwLine1.vs.re.SeedNLSJac8 * constantLoad.p.ir - constantLoad.P.$pDERNLSJac8.dummyVarNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_264(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[10] /* $res11.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = (data->localData[0]->realVars[127] /* pwLine1.vs.im variable */) * (jacobian->tmpVars[20] /* constantLoad.p.ii.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) + (jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->localData[0]->realVars[53] /* constantLoad.p.ii variable */) + (data->localData[0]->realVars[128] /* pwLine1.vs.re variable */) * (jacobian->seedVars[2] /* constantLoad.p.ir.SeedNLSJac8 SEED_VAR */) + (jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */) * (data->localData[0]->realVars[54] /* constantLoad.p.ir variable */) - jacobian->tmpVars[4] /* constantLoad.P.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */;
  TRACE_POP
}
...
equation index: 265
type: SIMPLE_ASSIGN
$res12._$pDERNLSJac8._dummyVarNLSJac8 = $cse1 * gENCLS.vq.$pDERNLSJac8.dummyVarNLSJac8 + (-$cse2) * gENCLS.vd.$pDERNLSJac8.dummyVarNLSJac8 - pwLine1.vr.im.SeedNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_265(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[11] /* $res12.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = (data->localData[0]->realVars[26] /* $cse1 variable */) * (jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) + ((-data->localData[0]->realVars[27] /* $cse2 variable */)) * (jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */;
  TRACE_POP
}
...
equation index: 266
type: SIMPLE_ASSIGN
$res13._$pDERNLSJac8._dummyVarNLSJac8 = $cse2 * gENCLS.vq.$pDERNLSJac8.dummyVarNLSJac8 + $cse1 * gENCLS.vd.$pDERNLSJac8.dummyVarNLSJac8 - pwLine1.vr.re.SeedNLSJac8
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_266(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[12] /* $res13.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = (data->localData[0]->realVars[27] /* $cse2 variable */) * (jacobian->tmpVars[15] /* gENCLS.vq.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) + (data->localData[0]->realVars[26] /* $cse1 variable */) * (jacobian->tmpVars[16] /* gENCLS.vd.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */) - jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */;
  TRACE_POP
}
...
equation index: 267
type: SIMPLE_ASSIGN
$res14._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.is.re.$pDERNLSJac8.dummyVarNLSJac8 else pwLine1.vs.re.SeedNLSJac8 - pwLine1.vr.re.SeedNLSJac8 - (pwLine1.Z.re * (pwLine1.is.re.$pDERNLSJac8.dummyVarNLSJac8 + pwLine1.vs.im.SeedNLSJac8 * pwLine1.Y.im - pwLine1.vs.re.SeedNLSJac8 * pwLine1.Y.re) - pwLine1.Z.im * (pwLine1.is.im.SeedNLSJac8 + (-pwLine1.vs.re.SeedNLSJac8) * pwLine1.Y.im - pwLine1.vs.im.SeedNLSJac8 * pwLine1.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_267(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[13] /* $res14.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp93 && tmp94)?jacobian->tmpVars[21] /* pwLine1.is.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */:jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[293]) * (jacobian->tmpVars[21] /* pwLine1.is.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[290]) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[291]))) - ((data->simulationInfo->realParameter[292]) * (jacobian->seedVars[4] /* pwLine1.is.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[290]) - ((jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[291]))))));
  TRACE_POP
}
...
equation index: 268
type: SIMPLE_ASSIGN
$res15._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.is.im.SeedNLSJac8 else pwLine1.vs.im.SeedNLSJac8 - pwLine1.vr.im.SeedNLSJac8 - (pwLine1.Z.re * (pwLine1.is.im.SeedNLSJac8 + (-pwLine1.vs.re.SeedNLSJac8) * pwLine1.Y.im - pwLine1.vs.im.SeedNLSJac8 * pwLine1.Y.re) + pwLine1.Z.im * (pwLine1.is.re.$pDERNLSJac8.dummyVarNLSJac8 + pwLine1.vs.im.SeedNLSJac8 * pwLine1.Y.im - pwLine1.vs.re.SeedNLSJac8 * pwLine1.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_268(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[14] /* $res15.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp95 && tmp96)?jacobian->seedVars[4] /* pwLine1.is.im.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[293]) * (jacobian->seedVars[4] /* pwLine1.is.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[290]) - ((jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[291]))) + (data->simulationInfo->realParameter[292]) * (jacobian->tmpVars[21] /* pwLine1.is.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[290]) - ((jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[291])))));
  TRACE_POP
}
...
equation index: 269
type: SIMPLE_ASSIGN
$res16._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.ir.re.$pDERNLSJac8.dummyVarNLSJac8 else pwLine1.vr.re.SeedNLSJac8 - pwLine1.vs.re.SeedNLSJac8 - (pwLine1.Z.re * (pwLine1.ir.re.$pDERNLSJac8.dummyVarNLSJac8 + pwLine1.vr.im.SeedNLSJac8 * pwLine1.Y.im - pwLine1.vr.re.SeedNLSJac8 * pwLine1.Y.re) - pwLine1.Z.im * (pwLine1.ir.im.$pDERNLSJac8.dummyVarNLSJac8 + (-pwLine1.vr.re.SeedNLSJac8) * pwLine1.Y.im - pwLine1.vr.im.SeedNLSJac8 * pwLine1.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_269(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[15] /* $res16.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp97 && tmp98)?jacobian->tmpVars[17] /* pwLine1.ir.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */:jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[21] /* pwLine1.vs.re.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[293]) * (jacobian->tmpVars[17] /* pwLine1.ir.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[290]) - ((jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[291]))) - ((data->simulationInfo->realParameter[292]) * (jacobian->tmpVars[18] /* pwLine1.ir.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + ((-jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[290]) - ((jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[291]))))));
  TRACE_POP
}
...
equation index: 270
type: SIMPLE_ASSIGN
$res17._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine1.t1 and time < pwLine1.t2 then pwLine1.ir.im.$pDERNLSJac8.dummyVarNLSJac8 else pwLine1.vr.im.SeedNLSJac8 - pwLine1.vs.im.SeedNLSJac8 - (pwLine1.Z.re * (pwLine1.ir.im.$pDERNLSJac8.dummyVarNLSJac8 + (-pwLine1.vr.re.SeedNLSJac8) * pwLine1.Y.im - pwLine1.vr.im.SeedNLSJac8 * pwLine1.Y.re) + pwLine1.Z.im * (pwLine1.ir.re.$pDERNLSJac8.dummyVarNLSJac8 + pwLine1.vr.im.SeedNLSJac8 * pwLine1.Y.im - pwLine1.vr.re.SeedNLSJac8 * pwLine1.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_270(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[16] /* $res17.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp99 && tmp100)?jacobian->tmpVars[18] /* pwLine1.ir.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */:jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[293]) * (jacobian->tmpVars[18] /* pwLine1.ir.im.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + ((-jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[290]) - ((jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[291]))) + (data->simulationInfo->realParameter[292]) * (jacobian->tmpVars[17] /* pwLine1.ir.re.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_DIFF_VAR */ + (jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[290]) - ((jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[291])))));
  TRACE_POP
}
...
equation index: 271
type: SIMPLE_ASSIGN
$res18._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine4.t1 and time < pwLine4.t2 then pwLine4.ir.re.SeedNLSJac8 else pwLine1.vr.re.SeedNLSJac8 - pwLine3.vr.re.SeedNLSJac8 - (pwLine4.Z.re * (pwLine4.ir.re.SeedNLSJac8 + pwLine1.vr.im.SeedNLSJac8 * pwLine4.Y.im - pwLine1.vr.re.SeedNLSJac8 * pwLine4.Y.re) - pwLine4.Z.im * (pwLine4.ir.im.SeedNLSJac8 + (-pwLine1.vr.re.SeedNLSJac8) * pwLine4.Y.im - pwLine1.vr.im.SeedNLSJac8 * pwLine4.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_271(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[17] /* $res18.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp101 && tmp102)?jacobian->seedVars[11] /* pwLine4.ir.re.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[315]) * (jacobian->seedVars[11] /* pwLine4.ir.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[312]) - ((jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[313]))) - ((data->simulationInfo->realParameter[314]) * (jacobian->seedVars[10] /* pwLine4.ir.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[312]) - ((jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[313]))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_272(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[18] /* $res19.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp103 && tmp104)?jacobian->seedVars[8] /* pwLine4.is.re.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[315]) * (jacobian->seedVars[8] /* pwLine4.is.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[312]) - ((jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[313]))) - ((data->simulationInfo->realParameter[314]) * (jacobian->seedVars[1] /* pwLine4.is.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[312]) - ((jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[313]))))));
  TRACE_POP
}
...
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_273(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[19] /* $res20.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp105 && tmp106)?jacobian->seedVars[1] /* pwLine4.is.im.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[315]) * (jacobian->seedVars[1] /* pwLine4.is.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[312]) - ((jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[313]))) + (data->simulationInfo->realParameter[314]) * (jacobian->seedVars[8] /* pwLine4.is.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[312]) - ((jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[313])))));
  TRACE_POP
}
...
equation index: 274
type: SIMPLE_ASSIGN
$res21._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine3.t1 and time < pwLine3.t2 then pwLine3.ir.im.SeedNLSJac8 else pwLine3.vr.im.SeedNLSJac8 - pwLine1.vs.im.SeedNLSJac8 - (pwLine3.Z.re * (pwLine3.ir.im.SeedNLSJac8 + (-pwLine3.vr.re.SeedNLSJac8) * pwLine3.Y.im - pwLine3.vr.im.SeedNLSJac8 * pwLine3.Y.re) + pwLine3.Z.im * (pwLine3.ir.re.SeedNLSJac8 + pwLine3.vr.im.SeedNLSJac8 * pwLine3.Y.im - pwLine3.vr.re.SeedNLSJac8 * pwLine3.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_274(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[20] /* $res21.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp107 && tmp108)?jacobian->seedVars[0] /* pwLine3.ir.im.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[20] /* pwLine1.vs.im.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[304]) * (jacobian->seedVars[0] /* pwLine3.ir.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[301]) - ((jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[302]))) + (data->simulationInfo->realParameter[303]) * (jacobian->seedVars[9] /* pwLine3.ir.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[301]) - ((jacobian->seedVars[19] /* pwLine3.vr.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[302])))));
  TRACE_POP
}
...
equation index: 275
type: SIMPLE_ASSIGN
$res22._$pDERNLSJac8._dummyVarNLSJac8 = if time >= pwLine4.t1 and time < pwLine4.t2 then pwLine4.ir.im.SeedNLSJac8 else pwLine1.vr.im.SeedNLSJac8 - pwLine3.vr.im.SeedNLSJac8 - (pwLine4.Z.re * (pwLine4.ir.im.SeedNLSJac8 + (-pwLine1.vr.re.SeedNLSJac8) * pwLine4.Y.im - pwLine1.vr.im.SeedNLSJac8 * pwLine4.Y.re) + pwLine4.Z.im * (pwLine4.ir.re.SeedNLSJac8 + pwLine1.vr.im.SeedNLSJac8 * pwLine4.Y.im - pwLine1.vr.re.SeedNLSJac8 * pwLine4.Y.re))
*/
void OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_eqFunction_275(DATA *data, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  ...
  jacobian->resultVars[21] /* $res22.$pDERNLSJac8.dummyVarNLSJac8 JACOBIAN_VAR */ = ((tmp109 && tmp110)?jacobian->seedVars[10] /* pwLine4.ir.im.SeedNLSJac8 SEED_VAR */:jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */ - jacobian->seedVars[18] /* pwLine3.vr.im.SeedNLSJac8 SEED_VAR */ - ((data->simulationInfo->realParameter[315]) * (jacobian->seedVars[10] /* pwLine4.ir.im.SeedNLSJac8 SEED_VAR */ + ((-jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */)) * (data->simulationInfo->realParameter[312]) - ((jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[313]))) + (data->simulationInfo->realParameter[314]) * (jacobian->seedVars[11] /* pwLine4.ir.re.SeedNLSJac8 SEED_VAR */ + (jacobian->seedVars[14] /* pwLine1.vr.im.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[312]) - ((jacobian->seedVars[15] /* pwLine1.vr.re.SeedNLSJac8 SEED_VAR */) * (data->simulationInfo->realParameter[313])))));
  TRACE_POP
}
int OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_functionJacNLSJac8_column(void* inData, threadData_t *threadData, ANALYTIC_JACOBIAN *jacobian, ANALYTIC_JACOBIAN *parentJacobian)
{
  TRACE_PUSH

  DATA* data = ((DATA*)inData);
  int index = OpenIPSL_Examples_Controls_PSSE_ES_EXAC1_INDEX_JAC_NLSJac8;
